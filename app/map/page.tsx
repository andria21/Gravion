    ...
    return (
      <div className="pt-16 pb-20">
        <div className="container mx-auto px-4 py-12 text-center">
          <h1 className="text-2xl font-bold text-destructive">Error loading maps</h1>
        ...
        <div className="container relative z-10 mx-auto px-4 py-12">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-10">
              Interactive demonstration of Gravion&apos;s anomaly detection capabilities.
            </p>
          </div>
        </div>
      </section>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="grid grid-cols-1 gap-2">
                      <Button 
                        variant={activeMode === 'thermal' ? 'default' : 'outline'} 
                        size="sm" 
            ...
            <div className="lg:col-span-3">
              <HudContainer className="h-full">
                ...
                <div className="relative w-full aspect-video bg-black rounded overflow-hidden cursor-crosshair">
                  {!isLoaded ? (
                    <div className="absolute inset-0 flex items-center justify-center bg-card">
                      ...
                      <span className="text-sm font-mono">LOADING MAP DATA...</span>
                    </div>
                  ) : (
                    <GoogleMap
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
                  ...
                  <div className="text-xs p-3 bg-card/70 border border-primary/20 rounded font-mono space-y-1">
                    <div className="text-muted-foreground">SATELLITE COVERAGE:</div>
                    <div className="text-primary">83% OF TARGET AREA</div>
                  </div>
                  <div className="text-xs p-3 bg-card/70 border border-primary/20 rounded font-mono space-y-1">
                    <div className="text-muted-foreground">DETECTION CONFIDENCE:</div>
                    <div className="text-primary">93% IN OPTIMAL CONDITIONS</div>
                  </div>
                </div>
              </HudContainer>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              <SectionHeader 
                ...
                description="Our proprietary technology enables detection of anomalies in various environments and scenarios."
                className="mb-8"
              />
              ...
              <div className="space-y-6">
                <div className="p-4 bg-card/50 border border-primary/20 rounded">
                  <div className="flex items-center mb-2">
                    ...
                    <h3 className="text-lg font-medium">Thermal Signature Detection</h3>
                  </div>
                  <p className="text-sm text-muted-foreground">
                    Advanced thermal imaging can identify human-sized heat signatures through dense foliage and adverse weather conditions.
                  </p>
                </div>
                ...
                <div className="p-4 bg-card/50 border border-secondary/20 rounded">
                  <div className="flex items-center mb-2">
                    ...
                    <h3 className="text-lg font-medium">Subsurface Anomalies</h3>
                  </div>
                  <p className="text-sm text-muted-foreground">
                    Proprietary radar technology can detect submerged vessels and identify mineral compositions beneath the Earth&apos;s surface.
                  </p>
                </div>
                
                <div className="p-4 bg-card/50 border border-accent/20 rounded">
                  <div className="flex items-center mb-2">
                    <Target className="h-5 w-5 text-accent mr-2" />
                    <h3 className="text-lg font-medium">Pattern Recognition</h3>
                  </div>
                  <p className="text-sm text-muted-foreground">
                    AI-powered analysis identifies irregularities in terrain, movement patterns, and environmental conditions that indicate anomalies.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              <HudContainer className="h-full">
                <h3 className="text-xl font-medium mb-4">Detection Range by Environment</h3>
